...
namespace edz::ui {
    ...
    brls::View* GuiHexEditor::setupUI() {
        ...
        editor->registerAction("edz.gui.hexeditor.back"_lang,   brls::Key::B, [this, editor] { 
        ...
        editor->registerAction("edz.gui.hexeditor.nextpage"_lang, brls::Key::R, [this, editor] {
        ...
        editor->registerAction("edz.gui.hexeditor.perviouspage"_lang,   brls::Key::L, [this, editor] { 
            static cheat::types::Region heapRegion = cheat::CheatManager::getHeapRegion();
            static cheat::types::Region mainRegion = cheat::CheatManager::getMainRegion();
        ...
        editor->registerAction("edz.gui.hexeditor.goto"_lang,   brls::Key::Y, [this, editor] { 
